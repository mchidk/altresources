...
slide_layout= Layout.find_by_identifier('user_page_slide')
...
onecol_layout.prototype!(LinkableSystemPage, :title => "Slideshows",       :author => author, :identifier => Page::Identifiers::SLIDESHOWS,   :permalink => 'slideshows',   :editable_content => true)
